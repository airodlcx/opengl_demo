...
int main(int argv, char* argc[]) {
	...
	GLFWwindow* window = glfwCreateWindow(screenWidth, screenHigh, "LearnOpenGL", NULL, NULL);
	if (window == NULL) {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glm::mat4 projection;
		projection = glm::perspective(glm::radians(45.0f), screenWidth / screenHigh, 0.1f, 100.0f);
