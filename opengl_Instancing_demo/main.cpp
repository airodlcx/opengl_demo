...
int main() {
	...
	// --------------------
	GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "LearnOpenGL",
	NULL, NULL);
	if (window == NULL) {
	...
	Shader planetShader("advanced.vs", "advanced.frag");
	Shader instanceShader("instancing.vs", "instancing.frag");
